package com.yanfuchang.appium.common.base;
...
import com.yanfuchang.appium.common.listener.AssertionListener;
...
public class BaseAppium {
	...
	public AndroidElement waitAuto(final By by, int time) {
		try {
//			return new AndroidDriverWait(driver, time * 1000).until(new ExpectedCondition<WebElement>() {
//
